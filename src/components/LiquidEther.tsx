  ...
  gl_Position = vec4(pos, 1.0);
    ...
    class Advection extends ShaderPass {
      ...
      update(opts: { dt: number; isBounce: boolean; BFECC: boolean }) {
        ...
        if (this.line) this.line.visible = opts.isBounce;
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(props: any) {
        ...
        const mat = this.mouse.material as THREE.RawShaderMaterial;
        ...
        mat.uniforms.force.value.set(forceX, forceY);
        mat.uniforms.center.value.set(centerX, centerY);
        mat.uniforms.scale.value.set(props.cursor_size, props.cursor_size);
        super.update();
      }
    }
    ...
    class Simulation {
      ...
      update() {
        ...
        const pressureOut = this.poisson?.update({
          iterations: this.options.iterations_poisson
        });
        this.pressure?.update({ vel, pressure: pressureOut });
      }
    }
